...
const NotFound = () => {
  return (
    <Flex as="section" className="min-h-screen w-full justify-center -mt-25">
      <Flex className="flex-col  gap-5">
        ...
        <p className="max-w-xl text-center">
          We can&apos;t seem to find the page you&apos;re looking for. It might have drifted off into the digital ether, or the link might be broken.
        ...
        <Flex className="flex-col  gap-3 bg-white rounded-full px-10 py-5 text-xs">
