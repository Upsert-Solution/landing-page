...
const page = () => {
  return (
    <>
      <Flex as="section" className="w-full min-h-[calc(100svh-6rem)] items-center py-16 lg:py-24">
        <HeroSection />
      </Flex>
      {/* Another Section */}
      <Flex as="section" className="flex-col gap-12 lg:gap-16 py-6 lg:py-12">
        ...
        <Grid cols={1} className="w-full md:grid-cols-3 gap-6 lg:gap-8">
            ...
            return (
              <CardContainer
                ...
                className={cn(
                  ...
                  isFeatured && "md:-translate-y-2 md:scale-[1.03] bg-brand-primary! border-transparent! shadow-[0_24px_60px_rgba(46,91,255,0.35)]!",
                )}
              >
                <span
                  className={cn(
      ...
      <Flex as="section" className="flex-col gap-12 lg:gap-16 py-6 lg:py-12">
        ...
        <Grid cols={1} className="w-full md:grid-cols-2 gap-6 lg:gap-8">
          {whatWeDoBest.map((item) => {
            const Icon = item.icon;

            return (
              <CardContainer key={item.title} className="h-full">
      ...
      <Flex as="section" className="py-12 lg:py-20 items-center">
